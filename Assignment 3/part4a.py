...
eta, t, h, mew, RMSerr, WIH_00, WHO_00 = NN.train(np.array(input_train), np.array(targets), eta=0.5, mew = 0.05, t=5000, n_batch = 500)
...
print()
print("10 Digit Classifier Results with eta=%.1f %d Iterations and %d Hidden Units and %0.2f Momentum" % (eta, t, h, mew))
print()
